...
function Greensec() {
  return (
    <div className='bg-primary text-primary-foreground flex justify-center items-center flex-col mt-10 p-6 sm:p-10 md:p-20'>
      ...
      <Button className='rounded-full mt-3 sm:mt-4 md:mt-5 bg-secondary text-secondary-foreground '>
        Schedule Now
      </Button>
    </div>
  )
